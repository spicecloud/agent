...
class Inference:
    ...
    async def _async_update_inference_job(
        self,
        inference_job_id: str,
        status: str,
        was_guarded: Optional[bool] = None,
        ...
        try:
            result = await self.spice.session.execute_async(
    ...
    async def run_pipeline(
        ...
        result = await self._async_update_inference_job(
        ...
        try:
            if is_text_input and is_text_output:
                ...
                response = await self._async_update_inference_job(
                    inference_job_id=inference_job_id,
                    status="COMPLETE",
            ...
            await self._async_update_inference_job(
                inference_job_id=inference_job_id,
                status="ERROR",
